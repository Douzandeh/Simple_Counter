...
A simple and lightweight counter app built with **React** (created using *Create React App*).  
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Douzandeh/Simple_Counter.git
```
...
* Learn how to deploy a React app using **GitHub Pages**
